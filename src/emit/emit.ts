...
Handlebars.registerHelper('flat', (a: unknown) => {
    if (!Array.isArray(a)) {
        throw new Error(`flat: argument is not an array, received: ${JSON.stringify(a)}`);
    }
...
Handlebars.registerHelper('count', (a: unknown, options: any) => {
    if (!Array.isArray(a)) {
        throw new Error(`count: argument is not an array, received: ${JSON.stringify(a)}`);
    }
...
Handlebars.registerHelper('toUpperCase', (a: unknown) => {
    if (typeof a !== 'string') {
        throw new Error(`toUpperCase: argument is not a string, received: ${JSON.stringify(a)}`);
    }
...
Handlebars.registerHelper('hex', (a: unknown) => {
    ...
    if (isNaN(an)) {
        throw new Error(`hex: argument should be a number, received: ${JSON.stringify(a)}`);
    }
...
Handlebars.registerHelper('oct', (a: unknown) => {
    ...
    if (isNaN(an)) {
        throw new Error(`oct: argument should be a number, received: ${JSON.stringify(a)}`);
    }
...
Handlebars.registerHelper('bin', (a: unknown) => {
    ...
    if (isNaN(an)) {
        throw new Error(`bin: argument should be a number, received: ${JSON.stringify(a)}`);
    }
